...
import { allcompleted, clearcompleted } from '../../redux/todo/action';
import addTodo from '../../redux/todo/thunk/addTodo';

const Header = () => {
    const text = useRef('');
    const dispatch = useDispatch();
    const addsTodo = (event) => {
    ...
    return (
        <div>
            <form
                class="flex items-center bg-gray-100 px-4 py-4 rounded-md" onSubmit={addsTodo}
            >
                <img
                    src={noteImg}
                    class="w-6 h-6"
